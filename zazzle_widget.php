...
class EZP_ZazzleWidget extends WP_Widget
{
    function EZP_ZazzleWidget()
    {
        $widget_ops = array(
            'classname'     => 'elegant_zazzle_widget', 
            'description'   => __("Elegant Zazzle Widget to showcase Zazzle products on your WordPress site.")
        );
        $control_ops = array('width' => 200, 'height' => 500);
        $this->WP_Widget('elegant_zazzle_widget', __('Elegant Zazzle Widget'), $widget_ops, $control_ops);
    }
...
add_action('widgets_init', create_function('', 'return register_widget("EZP_ZazzleWidget");'));
